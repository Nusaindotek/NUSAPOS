...
function bukaHalamanKustom(index) {
    ...
    document.getElementById('isiLayarKustom').innerHTML = `
        <div style="text-align:center; padding:20px;">
            <h4>📄 ${menu.nama}</h4>
            <p style="color:#ccc; font-size:14px;">Halaman ini masih kosong.</p>
            <p style="font-size:12px;">Silakan isi konten halaman ini di file index.html bagian id="isiLayarKustom"</p>
        </div>`;
}
